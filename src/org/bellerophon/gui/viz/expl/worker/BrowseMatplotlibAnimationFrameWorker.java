 ...
 * 
 * Filename: BrowseMatplotlibAnimationFrameWorker.java
 ...
 * @author Eric J. Lingerfelt
 */
public class BrowseMatplotlibAnimationFrameWorker extends SwingWorker<ErrorResult, Void>{
	 ...
	 */
	public BrowseMatplotlibAnimationFrameWorker(Frame parent, VizExplBrowsePanel panel, VizSet vs, MatplotlibAnimation va, int frame){
		this.parent = parent;
		this.vs = vs;
		this.va = va;
		this.panel = panel;
