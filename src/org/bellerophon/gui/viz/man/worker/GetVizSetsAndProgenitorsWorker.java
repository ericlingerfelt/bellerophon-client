 ...
 * @author Eric J. Lingerfelt
 */
public class GetVizSetsAndProgenitorsWorker extends SwingWorker<ErrorResult, Void>{
	 ...
	 */
	public GetVizSetsAndProgenitorsWorker(Frame frame, VizManPanel panel, DelayDialog dialog, VizManPanel.VizManMode mode){
		this.frame = frame;
		this.panel = panel;
		this.dialog = dialog;
		this.mode = mode;
