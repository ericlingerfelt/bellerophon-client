 ...
 * 
 * Filename: DeleteVizSetWorker.java
 ...
 * @author Eric J. Lingerfelt
 */
public class DeleteVizSetWorker extends SwingWorker<ErrorResult, Void>{
	 ...
	 */
	public DeleteVizSetWorker(Frame frame, VizManSelectPanel panel, VizSet vs){
		this.frame = frame;
		this.panel = panel;
		this.vs = vs;
		
		String string = "Please wait while visualization set number " + vs.getIndex() + ": " + vs.getVizSetId() + " is deleted.";
	...
	protected ErrorResult doInBackground(){
		delayDialog.open();
		return WebServiceCom.getInstance().doWebServiceComCall(vs, Action.DELETE_VIZ_SET);
	}
