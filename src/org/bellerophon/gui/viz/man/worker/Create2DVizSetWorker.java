 ...
 * @author Eric J. Lingerfelt
 */
public class Create2DVizSetWorker extends SwingWorker<ErrorResult, Void>{
	 ...
	 */
	public Create2DVizSetWorker(Frame frame, VizManPanel parent, VizSet d, DelayDialog dialog){
		this.frame = frame;
		this.parent = parent;
		this.d = d;
		this.dialog = dialog;
	...
	protected ErrorResult doInBackground(){
		return WebServiceCom.getInstance().doWebServiceComCall(d, Action.CREATE_2D_VIZ_SET);
	}
