 ...
 * @author Eric J. Lingerfelt
 */
public class Mod3DVizSetWorker extends SwingWorker<ErrorResult, Void>{
	 ...
	 */
	public Mod3DVizSetWorker(Frame frame, VizManPanel parent, VizSet d){
		this.frame = frame;
		this.parent = parent;
		this.d = d;
	}
	...
	protected ErrorResult doInBackground(){
		ErrorResult result = WebServiceCom.getInstance().doWebServiceComCall(d, Action.MOD_3D_VIZ_SET);
		if(result.isError()){
			return result;
		}
